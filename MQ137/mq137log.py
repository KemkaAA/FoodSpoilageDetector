...
if __name__ == '__main__':
    ...
    csv_file_path = '/home/kemkaa/MQ137/mq137.csv'
    try:
        ...
        if chan.voltage > 0:
            ...
            try:
                with open(csv_file_path, 'a') as f:
                    ...
                    f.write(f"{timestamp[0]},{timestamp[1]},{ppm:.2f},{voltage:.4f},{rs:.2f}\r\n")
                print(f"Logged data: {timestamp[0]},{timestamp[1]},{ppm:.2f} ppm,{voltage:.4f} V,{rs:.2f} ohms")
            except Exception as e:
